-- =====================================================================
-- CareVault Simplified Schema - 单向共享模式
-- =====================================================================
-- 简化设计：Caregiver 上传内容，所有 Patient 都能查看
-- 移除复杂的 care_recipients 一对多关系
-- =====================================================================
...
COMMENT ON TABLE public.emergency_contacts IS 'Emergency contacts, visible to all users';
...
-- Function: 自动同步 auth.users 到 public.users
...
CREATE POLICY "All users can view emergency contacts"
